...
<body class="not-transparent-header">
	<div class="container-wrapper">
		<header id="header">
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function"> <!-- navbar ko top header ko halka green rakhna background me -->
				<div class="container">
					<div class="logo-wrapper">
						<div class="logo">
							<a href="./"><img src="images/logo.png" alt="Logo" /></a> <!-- yaha pe img lagaya hai night job ka vo images folder me save hai
							                                                               name same rakhna aor apni notify ki logo laga dena same size me-->
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							<ul class="address-list">
								<li>
									<h5>Address</h5>
									<address> Mathura, <br /> P.O. mathura <br /> NH-2</address>
								</li>
								<li>
									<h5>Email</h5><a href="mailto:nightingale.nath2@gmail.com">job~notify@gmail.com</a>
								</li>
								<li>
									<h5>Phone Number</h5><a href="tel:+233 546 607 474">+91-4858792981</a>
								</li>
								<li>
