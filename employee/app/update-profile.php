...
$country = $_POST['country'];
	...
	$stmt = $conn->prepare("UPDATE tbl_users SET first_name = :fname, last_name = :lname, gender = :gender, bdate = :bdate , bmonth = :bmonth , byear = :byear, email = :email, education = :education, title = :title,  street = :street, zip = :zip, country = :country, phone = :phone, about = :about WHERE member_no='$myid'");
